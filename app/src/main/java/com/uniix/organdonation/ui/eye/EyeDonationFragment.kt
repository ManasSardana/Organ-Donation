...
class EyeDonationFragment : Fragment(){
    private lateinit var eyeDonationFragment : FragmentEyeDonationBinding
    ...
    private fun fetchData() {
        ...
        val stringRequest: StringRequest = StringRequest(
            Request.Method.GET,"https://shopwithankit.000webhostapp.com/OrgDo/hospitals_data.php", {
                ...
                eyeDonationFragment.eyeDonationHospitalsDetails.layoutManager = LinearLayoutManager(context)
                eyeDonationFragment.eyeDonationHospitalsDetails.adapter = HospitalDetailsAdapter(data)
